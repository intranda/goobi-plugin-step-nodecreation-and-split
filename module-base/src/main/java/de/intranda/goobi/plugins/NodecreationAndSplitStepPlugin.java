...
public class NodecreationAndSplitStepPlugin implements IStepPluginVersion2 {
    ...
    public void initialize(Step step, String returnPath) {
        ...
        log.info("NodecreationAndSplit step plugin initialized");
    }
    ...
    public String getPagePath() {
        return "/uii/plugin_step_nodecreation_and_split.xhtml";
    }
    ...
    public PluginReturnValue run() {
        ...
        log.info("NodecreationAndSplit step plugin executed");
        if (!successful) {
